...
//import com.unity.watcher.client.UnityClientMeasurements;
//import com.unity.watcher.common.utils.DebugLog;
    ...
    int opsDone = 0;
      ...
      terminator.interrupt();
		...
		try
		{
			...
			//System.out.println("============ before clientup ===============");
			//System.out.println(UnityClientMeasurements.getOutputString());
			/*try {
				Thread.sleep(10000);
			...
			workload.cleanup();
			//System.out.println("============ after clientup ===============");
			//System.out.println(UnityClientMeasurements.getOutputString());
			/*try {
				Thread.sleep(10000);
			} catch (InterruptedException e) {
