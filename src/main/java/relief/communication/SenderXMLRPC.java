...
public class SenderXMLRPC {
	...
	public String reqHandlerName;// = "UnityServerEngine.handleClientRequest";
	...
	public SenderXMLRPC() {
		try {
			...
			reqHandlerName = "ReliefController.handleClientRequest";
...
//	}
	...
	public Message send(Message msg) throws Exception {
		Vector<Object> requestParams;
		requestParams = new Vector<Object>();
		requestParams.addElement(ObjectSerializer.serialize(msg));
		Object result = client
				.execute(reqHandlerName, requestParams);
